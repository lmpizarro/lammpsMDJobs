...
class ExpProps():
    def __init__(self):
        self.exp_props ={'Fe': {'a': 2.87, 'Ec': 4.28, 'Evf':1.79,'B':170, 
                ...
                'Evf':2.2 },
                   'Mo':{'a':3.1472, 'Ec':6.82, 'Evf':3.10, 'B':230, 
                'cijexp':{'C11':463.7, 'C12':157.8 , 'C44':109.2}},
                   'Nb':{'a':3.3, 'Ec':7.57, 'Evf':2.75, 'B':170, 
                'cijexp':{'C11':247, 'C12':135 , 'C44':28.7}},
                   'Ta':{'a':3.3, 'Ec':8.1, 'Evf':2.18,'B':200, 
                  'cijexp':{'C11':266.3, 'C12':158.2 , 'C44':87.4}},
                   'W':{'a':3.16, 'Ec':8.9, 'Evf':3.95, 'B':310, 
                 'cijexp':{'C11':532, 'C12':204.9 , 'C44':163.1}},
            'Cu':{'a':3.61, 'Ec':3.49, 'Evf':1.28, 'B':140, 
                'cijexp':{'C11':168.4, 'C12':121.4 , 'C44':75.4}},
            'Ag':{'a':4.09 , 'Ec':2.95, 'Evf':1.1, 'B':100,
                'cijexp':{'C11':124, 'C12':93.7 , 'C44':46.1}},
            'Au':{'a':4.08 , 'Ec':3.81, 'Evf':0.9, 'B':220,  
                'cijexp':{'C11':192.3, 'C12':163.1 , 'C44':42.0}},
            'Ni':{'a':3.52 , 'Ec':4.44, 'Evf':1.6,'B':180, 
                  'cijexp':{'C11':245, 'C12':140 , 'C44':125}},
            'Pd':{'a':3.89, 'Ec':3.89, 'Evf':1.4, 'B':180, 
                  'cijexp':{'C11':227.1, 'C12':176.1 , 'C44':71.7}},
            'Pt':{'a':3.92, 'Ec':5.84, 'Evf':1.5, 'B':230, 
