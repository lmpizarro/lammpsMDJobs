...
'''
exp_props ={'Fe': {'a': 2.87, 'Ec': 4.28, 'C11':2.26, 
                   'C12': 1.4, 'C44':1.16, 'Evf':1.79 },
            'V':{'a':3.03 , 'Ec':5.31 , 'C11':2.29, 
                   'C12':1.4 , 'C44':1.16, 'Evf':1.79 },
            'Mo':{'a':3.1472 , 'Ec':6.82 , 'C11':4.637, 
                   'C12':1.578 , 'C44':1.092, 'Evf':3.1 },
            'Nb':{'a':3.3 , 'Ec':7.57, 'C11':2.47, 
                   'C12':1.35 , 'C44':0.287, 'Evf':2.75 },
            'Ta':{'a':3.3 , 'Ec':8.1 , 'C11':2.663, 
                   'C12':1.582 , 'C44':0.874, 'Evf':2.18 },
            'W':{'a':3.16 , 'Ec':8.9 , 'C11':5.32, 
                   'C12':2.049 , 'C44':1.631, 'Evf':3.95 },
            'Cu':{'a':3.61 , 'Ec':3.49 , 'C11':1.684, 
                   'C12':1.214 , 'C44':0.754, 'Evf':1.28 },
            'Ag':{'a':4.09 , 'Ec':2.95 , 'C11':1.24, 
                   'C12':0.937 , 'C44':0.461, 'Evf':1.1 },
            'Au':{'a':4.08 , 'Ec':3.81 , 'C11':1.923, 
                   'C12':1.631 , 'C44':0.420, 'Evf':0.9 },
            'Ni':{'a':3.52 , 'Ec':4.44 , 'C11':2.45, 
                   'C12':1.4 , 'C44':1.25, 'Evf':1.6 },
            'Pd':{'a':3.89 , 'Ec':3.89 , 'C11':2.271, 
